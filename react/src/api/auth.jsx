...
import './axiosLoginErrorInterceptor';
import './axiosRegisterErrorInterceptor';

export async function registerMember(data) {
  // This call now receives either a normal axios response (2xx)
  // or, for /api/auth/register/ 400, the `response` object resolved by
  // axiosRegisterErrorInterceptor instead of a rejected error.
